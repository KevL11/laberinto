...
int main() {
    ...
    // Tama�os recomendados para generar. Puede establecer cualquier alto y ancho
    // pero en algunos casos los espacios vac�os en el laberinto generado pueden 
    // ser m�s grandes. Por lo tanto, se recomienda utilizar los tama�os sugeridos
